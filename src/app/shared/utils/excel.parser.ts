...
export const convertExcelRowToBasicPlanning = (row: Row): any => {
  return <any>{
...
export const convertExcelRowToUmexPlanning = (row: Row): any => {
  return <any>{
    operation: +`${row[0]}`.split(' ')[0],
    truckLicensePlateFront: row[1],
    truckLicensePlateBack: row[2],
...
export const convertExcelRowToChimpexPlanning = (row: Row): any => {
  return <any>{
    operation: +`${row[0]}`.split(' ')[0],
    truckLicensePlateFront: row[1],
    truckLicensePlateBack: row[2],
...
export const convertExcelRowToComvexPlanning = (row: Row): any => {
  return <any>{
    operation: +`${row[0]}`.split(' ')[0],
    truckLicensePlateFront: row[1],
    truckLicensePlateBack: row[2],
