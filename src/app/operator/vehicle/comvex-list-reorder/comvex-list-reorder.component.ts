...
@Component({
  selector: 'app-comvex-list-reorder',
  templateUrl: './comvex-list-reorder.component.html',
  styleUrls: ['./comvex-list-reorder.component.scss']
})
export class ComvexListReorderComponent implements OnChanges, OnDestroy {
